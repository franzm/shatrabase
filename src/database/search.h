...
/*
 Search - different ways to lookup games
*/

/* The Search class is an abstract base class that represents a search on one criterion.
@todo
...
/* The TagSearch class is used for tag search.
   Only simple substring searches are supported for now.
@todo
Improve performance by creating a bit array of matching values */
