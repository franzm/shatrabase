...
/** @ingroup Database
   The MemoryDatabase class provides database access to SGN files.
   Games are stored in memory, and are editable.
   The class is derived from the SgnDatabase class, providing methods for the
...
class MemoryDatabase : public SgnDatabase
{
	Q_OBJECT
public:
	/** Default constructor */
