...
public:
	...
	/** String constructor. Creates date from SGN date format (e.g. "1990.01.??"). */
	...
	QDate asDate() const;
	/** Converts date to string. Uses SGN date format (e.g. "1990.01.??"). */
    ...
    /** Sets date from string in SGN date format (e.g. "1990.01.??"). */
