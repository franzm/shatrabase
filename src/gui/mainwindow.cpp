    ...
    m_nextGameSaveQuick(false)
{
    ...
    connect(m_gameList, SIGNAL(requestDeleteGames(QVector<int>)), SLOT(slotDatabaseDeleteGames(QVector<int>)));
...
void MainWindow::setupActions()
{
    ...
    */
    ...
    editremove->addAction(createAction(tr("Game result"),
                        SLOT(slotEditRemoveResult())));
    edit->addSeparator();
